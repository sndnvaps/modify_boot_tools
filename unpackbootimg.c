...
int usage() {
    ...
    printf("\texample:unpackbootimg -i boot.img \n");
    printf("\texample:unpackbootimg -i boot.img -o output_directory \n");
    printf("\texample:unpackbootimg -i boot.img -o output_directory -p <size-in-hexadcimal> \n");
    return 0;
}
